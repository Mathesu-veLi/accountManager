...
Type 2 to view saved accounts
Type 3 to delete an account
Type 4 to exit the program \n""")
    ...
    try:
        match(option):
            case 1:
                website_name = str(input('Enter the name of the website where you registered your account (-1 to back to the options): '))
                if website_name == '-1':
                    raise RuntimeError()
            ...
            case 2:
                try:
                    ...
                    website_number = utils.custom_validate_number('Enter the number of the site you want to see your account details for (-1 to back to the options): ', files_count)
